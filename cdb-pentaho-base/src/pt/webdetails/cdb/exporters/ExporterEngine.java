...
public class ExporterEngine {
  ...
  public void exportToFile(HttpServletRequest request, HttpServletResponse response, String exporterName, String group, String id) throws IOException {
    ServletRequestWrapper wrapper = (ServletRequestWrapper) request;
    String url = wrapper.getScheme() + "://" + wrapper.getServerName() + ":" + wrapper.getServerPort() + PentahoRequestContextHolder.getRequestContext().getContextPath();
